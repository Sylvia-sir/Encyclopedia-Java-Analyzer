...
public class WordAnalyzerGUI extends JFrame { //implements WordAnalyzer {
    ...
    public WordAnalyzerGUI(WordAnalyzer wordAnalyzer) {
        ...
        setTitle("Word Analyzer unthreaded");
       setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ...
        countButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int count = 0;
				try {
					count = wordAnalyzer.Count(paragraph);
        ...
        repeatedWordsButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
				...
				try {
					repeatedWords = wordAnalyzer.repeatedwords(paragraph);
				} catch (RemoteException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
        ...
        longestButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String longest = null;
				try {
					longest = wordAnalyzer.longest(paragraph);
				} catch (RemoteException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
        ...
        shortestButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
				...
				try {
					shortest = wordAnalyzer.shortest(paragraph);
				} catch (RemoteException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
        ...
        repeated.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		...
        		try {
        			repeated = wordAnalyzer.Repeat(paragraph);
